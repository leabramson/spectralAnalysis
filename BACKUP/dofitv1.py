...
options.grid_path = \
  os.environ['GRID_PATH']+"/Padova1994/salpeter/bc2003_hr_stelib_m[metal]_salp_ssp.ised"
...
# Input files
specdata = ['753_1_B_'+bin+'.pyspec', '753_1_R_'+bin+'.pyspec']
...
# pixels intervals.
lsfdata = np.loadtxt('753_1_B_'+bin+'.lsf')
lsf1 = ArbitraryLSF(lsfdata[:,1])
lsfdata = np.loadtxt('753_1_R_'+bin+'.lsf')
